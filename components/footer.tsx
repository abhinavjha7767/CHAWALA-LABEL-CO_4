...
const footerLinks = {
  Products: [
    ...
    { label: "Printed Stickers", href: "#products" },
    { label: "Care Labels", href: "#services" },
    { label: "Satin Ribbons", href: "#services" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 py-16 lg:py-20">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <p className="text-[hsl(280,15%,60%)] leading-relaxed max-w-sm">
              Your trusted partner for premium brand labels, tags, stickers, and
              packaging solutions. Serving the fashion industry with excellence since 1995.
            </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-[hsl(280,20%,25%)] py-8">
          <p className="text-sm text-[hsl(280,15%,45%)]">
            &copy; {new Date().getFullYear()} AS PRINTERS - A unit of Chawala Company. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <Link href="#" className="text-sm text-[hsl(280,15%,45%)] hover:text-[hsl(300,20%,95%)] transition-colors">
              Privacy Policy
            </Link>
            <Link href="#" className="text-sm text-[hsl(280,15%,45%)] hover:text-[hsl(300,20%,95%)] transition-colors">
              Terms of Service
